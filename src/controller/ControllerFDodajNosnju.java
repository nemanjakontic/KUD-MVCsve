...
public class ControllerFDodajNosnju {
    ...
    public Nosnja sacuvajNosnju(Nosnja n) {
        return serviceNosnja.sacuvajNo(n);
    }

    public Nosnja izmeniNosnju(Nosnja n) {
        return serviceNosnja.izmeniNo(n);
    }

    public void obrisiNosnju(int sifra) {
        serviceNosnja.obrisiNo(sifra);
    }
