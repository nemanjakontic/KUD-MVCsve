...
public class ControllerFNoviClan {
    ...
    public Clan zapamtiClana(Clan clan) {
        return serviceClan.zapamtiCl(clan);
    }

    public void obrisiClana(Long brojCK) {
        serviceClan.obrisiCl(brojCK);
    }

    public Clan izmeniClana(Clan clan) {
        return serviceClan.izmeniCl(clan);
    }
